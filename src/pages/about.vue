<template>
  <main class="grid grid-cols-12">
    ...
    <div class="col-span-5 border-r grid grid-cols-[1fr,1rem]">
      <div class="border-r">
        <Sheets />
      </div>
      <div class="p-1">
        <div class="w-full h-1 bg-secondary-1"></div>
      </div>
    </div>
    <div class="col-span-5 grid grid-cols-[1fr,1rem]">
      <div class="border-r px-8 py-4">
